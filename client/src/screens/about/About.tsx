...
export const About = () => {
    return (
        <section>
            ...
            <p>This app was created by <A href="">@gareth</A> and <A href="">@sporgory</A> with the help of the <A href="https://discord.gg/2kWxhJywGq">AGON fan Discord community.</A></p>
