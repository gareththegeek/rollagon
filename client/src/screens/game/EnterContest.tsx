...
export const EnterContest = () => {
    ...
    return (
        <section>
            ...
            <p className="">Heroes join the contest by building their dice pool. Make sure everyone is ready before rolling the final results!</p>
            {contestants.length === 0 && isStrifePlayer
                && <Placeholder className="">No one has joined</Placeholder>}
            {players.map((playa) => (
